...
export const products: Product[] = [
  ...
  /* ---- Plainer stand-ins. Only reachable as another product's alternative. ---- */
  {
    id: "paper-napkins",
    name: "Plain Ivory Paper Napkins",
    category: "Tableware",
    themes: [THEME],
    colors: ["ivory"],
    image: blushNapkins,
    ...
    unit: "Pack of 50",
    coversChildren: 50,
    affiliateUrl: "https://www.target.com/s?searchTerm=ivory+paper+napkins",
    estimatedDelivery: "2 days",
    priority: "essential",
    activityIds: [],
    timelineIds: ["tea"],
  ...
  },
  {
    ...
    unit: "Pack of 24",
    coversChildren: 12,
    affiliateUrl: "https://www.target.com/s?searchTerm=ivory+paper+plates",
    estimatedDelivery: "2 days",
    priority: "essential",
    activityIds: [],
    timelineIds: ["tea", "cake"],
  ...
  },
  {
    ...
    unit: "Pack of 200",
    coversChildren: 10,
    affiliateUrl: "https://www.target.com/s?searchTerm=gold+star+stickers",
    estimatedDelivery: "2 days",
    priority: "essential",
    activityIds: ["crown-decorating", "garden-hunt"],
    timelineIds: ["arrival", "hunt"],
  ...
  {
    id: "cupcakes",
    name: "Ivory Buttercream Cupcakes",
    category: "Food & drink",
    themes: [THEME],
    colors: ["ivory"],
    image: goldCandles,
    ...
    alternativeOnly: true,
    diy: {
      name: "Home-baked cupcakes with a candle in the middle one",
      price: 9,
      prepMinutes: 90,
      note: "One boxed sponge, ivory buttercream and gold sprinkles — the cake moment, an hour and a half.",
    },
  },
  {
    id: "groceries-lean",
    name: "Simple tea-table groceries",
    category: "Food & drink",
    themes: [THEME],
    colors: ["ivory"],
    image: eucalyptus,
    ...
    alternativeOnly: true,
    diy: {
      name: "Sandwiches, fruit and homemade lemonade",
      price: 1.4,
      prepMinutes: 60,
      note: "Three things done properly instead of six — still a tea table, half the shopping.",
    },
  },
];
